...
public abstract class Publication implements Serializable, Comparable<Publication> {
    ...
    // mogą służyć do sprawdzania czy dana książka istnieje w zbiorze
    @Override
    ...
    public int compareTo(Publication p) {
        return title.compareToIgnoreCase(p.title); //porównujemy po tytule bez względu na litery czy dużę czy małe
    }
}
